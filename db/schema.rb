...
ActiveRecord::Schema.define(version: 20140703181222) do
  ...
  add_index "following_relationships", ["follower_id", "followed_user_id"], name: "FollowingRelationshipsUniquenessConstraint", unique: true, using: :btree
